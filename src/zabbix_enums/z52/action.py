"""https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object"""
...
class ActionOperationType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object#action-operation
...
class ActionOperationCommandType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object#action-operation-command
...
class ActionOperationMessageDefault(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object#action-operation-message
...
class ActionOperationConditionType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object#action-operation-condition
...
class ActionRecoveryOperationTypeTrigger(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object#action-recovery-operation
...
class ActionUpdateOperationTypeTrigger(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object#action-update-operation
...
class ActionFilterEvalType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object#action-filter
...
class ActionFilterCondidtionTypeTrigger(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/action/object#action-filter-condition
