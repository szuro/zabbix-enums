"""https://www.zabbix.com/documentation/5.2/en/manual/api/reference/host/object"""
from zabbix_enums import _ZabbixEnum


class HostAvailable(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/host/object#host
...
class HostInventoryProperty(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/host/object#host-inventory
