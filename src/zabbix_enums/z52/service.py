"""https://www.zabbix.com/documentation/5.2/en/manual/api/reference/service/object"""
from zabbix_enums import _ZabbixEnum


class ServiceAlgorithm(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/service/object#service
...
class ServiceTimeType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/service/object#service-time
...
class ServiceDependencySoft(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/service/object#service-dependency
