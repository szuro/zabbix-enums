"""https://www.zabbix.com/documentation/5.4/en/manual/api/reference/templatedashboard/object"""
...
class TemplateDashboardAutoStart(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.4/en/manual/api/reference/templatedashboard/object#template-dashboard
