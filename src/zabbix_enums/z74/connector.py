"""https://www.zabbix.com/documentation/7.4/en/manual/api/reference/connector/object"""
from zabbix_enums import _ZabbixEnum

class ConnectorProtocol(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/connector/object#connector
...
class TagFilerOperator(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/connector/object#tag-filter
