"""https://www.zabbix.com/documentation/7.4/en/manual/api/reference/settings/object"""
from zabbix_enums import _ZabbixEnum


class SettingsServerCheckInterval(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/settings/object#settings
...
class SettingsProxySecretsProvider(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/settings/object#settings

    Resolve secret macro values by
    """
    SERVER = 0
    SERVER_AND_PROXIES = 1
